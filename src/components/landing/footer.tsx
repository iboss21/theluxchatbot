    ...
    <footer className="border-t border-white/10 bg-black/20 backdrop-blur-sm">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-white/70 mb-4">
              Premium chatbots with a touch of luxe. Create, customize, and deploy AI chatbots that stand out.
            </p>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/50 text-sm">&copy; {new Date().getFullYear()} TheLux.app. All rights reserved.</p>
          <div className="mt-4 md:mt-0">
            <Link href="/status" className="text-white/50 hover:text-white text-sm transition-colors">
              System Status
            </Link>
