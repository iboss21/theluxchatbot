        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-primary hover:bg-primary/90 text-primary-foreground font-medium px-6 py-3 rounded-lg transition-colors inline-flex items-center justify-center"
            >
              Get Started
              <svg
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-foreground/10 hover:bg-foreground/20 text-foreground font-medium px-6 py-3 rounded-lg transition-colors inline-flex items-center justify-center border border-foreground/10"
            >
              Explore Features
            </motion.a>
          </motion.div>
